...
Original file is located at
    https://colab.research.google.com/drive/1IgxlbdxzPmB-y1tK8aBn8ZdhLa59INWv
"""
...
#Se ubica una ficha de manera aleatoria
    ...
    mapa_laberinto[fila_posicion_actual][columna_posicion_actual] = '10'
...
for index, value in enumerate(laberinto):
  for index2, value2 in enumerate(value):
    if value2 == '10':
      print ('la ficha se encuentra en la posicion: ', index, index2)
      posx = index
      posy = index2
for i in range(5):
#while True:
